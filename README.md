...
6. Do the same as Step 5 when the behavior of the advertisers is non-stationary by
...
● Produce a technical report describing the environment, the algorithms and the plot
representing the regret and the reward of every algorithm. Provide also a practical
application motivating the scenario.
