    ...
    for line in adj_matrix:
        ...
        for element in line:
            ...
            if element == 1:
                ...
                element = influence_probability(category_i=category_i, category_j=category_j, feature_values_i=feature_values[i], feature_values_j=feature_values[j])
...
def influence_probability(category_i=1, category_j=1, feature_values_i=None, feature_values_j=None, minimum=0.03, maximum=0.7):
