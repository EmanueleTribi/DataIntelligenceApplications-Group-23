...
# VERSION 1: Function that estimates the influence generated by a set of bids given the iterations
# VERSION 2: since the for loop was identical to the one used for "estimate_seeds" I decided to implement a seed estimate for each call
#            of this function (I looks more smart and less time consuming)
def estimate_bids_influence(social_network=None, ad_allocation_list=None, learner_id=1, slot_prominence=None, iterations=None):
    ...
    for _ in range(iterations):
        ...
        seeds += np.sum(social_network.active_nodes)
    ...
    return nodes_count / iterations, seeds / iterations
